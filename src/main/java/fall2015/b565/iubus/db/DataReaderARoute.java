...
public class DataReaderARoute {
    ...
    public Schedule getASheduleFall(int routeId) throws Exception{
        ...
        String queryString = "SELECT * FROM " + Constants.TableNames.A_MR_FALL_SCHEDULE_TABLE ;
    ...
    public List<ActualSchedule> getActualASheduleFall(int routeId) throws Exception{
        ...
        String connectionURL =  IUBusUtils.getJDBCUrl();
        Connection connection = null;
        String queryString = "SELECT e.day, e.busid, e.67, e.to39, e.to1, e.to12, e.to67 FROM " + Constants.TableNames.A_MR_FALL_ROUTE_TABLE  + " e ORDER BY e.day, e.67";
        System.out.println(queryString);
        PreparedStatement preparedStatement = null;
        try {
            connection = DriverManager.getConnection(connectionURL, IUBusUtils.getJDBCUser(), IUBusUtils.getJDBCPWD());
    ...
    public List<Date> getDistinctDatesFall() throws Exception{
        ...
        String connectionURL =  IUBusUtils.getJDBCUrl();
        Connection connection = null;
        String queryString = "SELECT DISTINCT(e.day) FROM " + Constants.TableNames.A_MR_FALL_ROUTE_TABLE +" e ORDER BY e.day ASC";
        System.out.println(queryString);
        PreparedStatement preparedStatement = null;
        try {
            connection = DriverManager.getConnection(connectionURL, IUBusUtils.getJDBCUser(), IUBusUtils.getJDBCPWD());
    ...
    public List<ActualSchedule> getActualASheduleSpring(int routeId) throws Exception{
        ...
        String connectionURL =  IUBusUtils.getJDBCUrl();
        Connection connection = null;
        String queryString = "SELECT e.day, e.busid, e.67, e.to39, e.to1, e.to12, e.to67 FROM " + Constants.TableNames.A_MR_SPRING_ROUTE_TABLE + " e ORDER BY e.day, e.67";
        System.out.println(queryString);
        PreparedStatement preparedStatement = null;
        try {
            connection = DriverManager.getConnection(connectionURL, IUBusUtils.getJDBCUser(), IUBusUtils.getJDBCPWD());
    ...
    public List<Date> getDistinctDatesSpring() throws Exception{
        ...
        String connectionURL =  IUBusUtils.getJDBCUrl();
        Connection connection = null;
        String queryString = "SELECT DISTINCT(e.day) FROM " + Constants.TableNames.A_MR_SPRING_ROUTE_TABLE +  " e ORDER BY e.day ASC";
        System.out.println(queryString);
        PreparedStatement preparedStatement = null;
        try {
            connection = DriverManager.getConnection(connectionURL, IUBusUtils.getJDBCUser(), IUBusUtils.getJDBCPWD());
